...
/**
 * Vat_tuController implements the CRUD actions for VatTu model.
 */
class Vat_tuController extends Controller
{
	 public $layout = 'admin';
    /**
     * @inheritdoc
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> Yii::t('app', 'Create new') . " VatTu",
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> Yii::t('app', 'Update'). " VatTu #".$id,
