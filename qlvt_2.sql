...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 06, 2024 lúc 02:57 AM
...
ALTER TABLE `phieu_xuat_kho`
  ...
  ADD CONSTRAINT `nguoi_duyet` FOREIGN KEY (`id_nguoi_duyet`) REFERENCES `nguoi_dung` (`id`),
  ADD CONSTRAINT `tai_xe` FOREIGN KEY (`id_tai_xe`) REFERENCES `tai_xe` (`id`),
  ADD CONSTRAINT `xe` FOREIGN KEY (`id_xe`) REFERENCES `xe` (`id`),
  ADD CONSTRAINT `yeu_cau` FOREIGN KEY (`id_bo_phan_yc`) REFERENCES `nguoi_dung` (`id`);
...
--
ALTER TABLE `vat_tu_xuat`
  ADD CONSTRAINT `id_nguoi_duyet` FOREIGN KEY (`id_nguoi_duyet`) REFERENCES `nguoi_dung` (`id`),
